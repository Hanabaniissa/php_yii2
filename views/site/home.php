            ...
            <div class="col-md-3">
                <div class="card shadow">
                    <div class="card-body" , style="background-color: #9cff2e;">
                        <a href="<?= Url::to(['site/view', 'id' => $category->id]) ?>" , style="color: #2192ff; text-decoration: none" ,
                           class="link-dark">
...
<!-- button -->
<div class="row">
    <span style="text-align: center; margin-top: 10px;"><?= Html::a('Create Post', Url::to('/site/post'), ['class' => 'btn btn-warning btn-lg','style'=>'color: #47555e']) ?> </span>
</div>
</div>
